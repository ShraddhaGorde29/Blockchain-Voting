...
import managecandidate.ViewCandidate;
import managecandidate.ViewCandidateFrame;
import static managecandidate.ViewCandidateFrame.alldata;

/**
 *
 * @author 2491
 */
public class ViewBureaucratsFrame extends javax.swing.JFrame {
    public static String alldata[][];
    /**
     * Creates new form ViewBureaucratsFrame
     */
    public ViewBureaucratsFrame() {
         super("View  Bureaucrats Frame");
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewBureaucratsFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewBureaucratsFrame().setVisible(true);
            }
        });
    }
