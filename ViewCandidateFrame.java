...
public class ViewCandidateFrame extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ViewSellFrame
     */
    public static String alldata[][];
    public ViewCandidateFrame() {
        super("View Candidate  Frame ");
        initComponents();
   //candidatename, age, sex, educationqualification, worth, profession, symbolname, partyname         
       
         ViewCandidate d = new ViewCandidate();
 
        String colname[]={"Candidate Name", "Age", "Sex", "Education Qualification"," Worth", "Profession", "Symbol Name","Party Name"};
        d.viewData();
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(410, 200, 1160, 275);
